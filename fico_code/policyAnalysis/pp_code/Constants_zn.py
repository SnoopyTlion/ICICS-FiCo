...
SHARE_ACTION = ['保护', '分发', '交易', '公布', '联合', '保持', '积累', '请求', '展示', '调用', '申请', '预填', '核验', '传输',
                '同步', '售卖', '得到', '报道', '分享', '查询', '发送', '修改', '发布', '完善', '授权']

COLLECT_ACTION = ['收集', '获取', '得到', '接收', '使用', '利用', '了解', '获得', '获知', '包括',
                  '存储', '检查', '存取', '用于', '提供', '供', '需要', '填写', '记录', '读取', '索取', '访问', '更改']

raw_SHARE_ACTION = ['保护', '分发', '交易', '公布', '联合', '保持', '积累', '请求', '展示', '调用', '申请', '预填', '核验', '传输',
                    '同步', '售卖', '得到', '报道', '分享', '查询', '发送', '修改', '发布', '完善', '授权']

raw_COLLECT_ACTION = ['收集', '获取', '得到', '接收', '使用', '利用', '了解', '获得', '获知', '包括',
                      '存储', '检查', '存取', '用于', '提供', '供', '需要', '填写', '记录', '读取', '索取', '访问', '更改']
